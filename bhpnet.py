...
def client_sender(buffer):
    ...
    try:
        ...
        exception_string = f"[*] Exception! Exiting. {e}"
...
def client_handler(client_socket):
    ...
    if len(upload_destination):
        ...
        try:
            ...
            client_socket.send(encode_string(f"Successfully saved file to {upload_destination}\r\n"))
        except Exception as e:
            client_socket.send(encode_string(f"Failed to save to {upload_destination} \r\n{e}"))
